...
const StandingTableType1 = () => {
  ...
  return (
    <div className="flex w-full h-full relative items-start justify-center">
      <ReactPlayer url={AwardVideo} width="100%" height="auto" playing loop />
      <div
        id="container1"
      ...
      >
        <div className="wrapper h-20 w-full relative justify-center items-center ">
          <div className="bg w-full">남자피지크 +178cm 순위발표</div>
          <div className="fg w-full">남자피지크 +178cm 순위발표</div>
        </div>
      </div>
      <div
        id="container2"
