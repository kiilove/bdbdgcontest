  ...
  return (
    <div className="flex w-full h-full bg-white justify-center items-start">
      ...
      >
        ...
        <div className="flex w-full justify-center items-start p-2 gap-x-3 h-auto font-light text-sm">
            ...
            <div className="flex border-2 w-auto h-auto border-black flex-col items-start justify-center">
              ...
              <div className="flex w-auto border-t-2 border-black">
                ...
                <div
                  ...
                  style={{ width: "100px" }}
                >
                  <span className="text-4xl font-semibold font-sans">2</span>
                </div>
              </div>
              <div className="flex w-auto border-t-2 border-black">
                <div
                ...
                <div
                  ...
                  style={{ width: "100px" }}
                >
                  <span className="text-4xl font-semibold font-sans">3</span>
                </div>
              </div>
              <div className="flex w-auto border-t-2 border-black">
                <div
                ...
                <div
                  ...
                  style={{ width: "100px" }}
                >
                  <span className="text-4xl font-semibold font-sans">1</span>
                </div>
              </div>
            </div>
          </div>
